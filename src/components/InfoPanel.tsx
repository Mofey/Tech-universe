...
export function InfoPanel({
  ...
  return (
    <aside className="absolute left-2 right-2 top-2 z-20 max-h-[42vh] overflow-y-auto rounded-2xl border border-cyan-300/30 bg-slate-950/95 p-3 shadow-[0_0_40px_rgba(0,150,255,0.2)] backdrop-blur-xl sm:left-5 sm:right-auto sm:top-5 sm:max-h-none sm:max-w-[380px] sm:p-5">
      ...
      <div
        className={`mt-3 border-t border-cyan-300/20 pt-3 sm:mt-4 sm:block sm:pt-4 ${
